...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 18, textAlign: "center", color: "#1E0A00", marginBottom: 4, fontWeight: "bold" },
  ...
  seal: { width: 60, height: 60, borderRadius: 30, backgroundColor: "#A60C06", alignSelf: "center", alignItems: "center", justifyContent: "center", border: "2 solid #FFCD6E", marginTop: 8 },
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.text}>Par la volonté des ancêtres, toi que l&apos;on nomme N. E. RONALD BILL, fils des terres rouges et des rivières lointaines, ce parchemin est le témoignage de ton archétype ancestral : le Guerrier.</Text>
        <Text style={styles.text}>Le feu qui brûle en toi est la flamme des anciens. Ta lignée s&apos;étend sur sept générations de protecteurs et de bâtisseurs.</Text>
        <View style={styles.seal}><Text style={styles.fleur}>⚜</Text></View>
        <Text style={{ textAlign: "right", fontSize: 9, color: "#8A520D", fontStyle: "italic", marginTop: 10 }}>✦ SENYCE PARTNERS ✦</Text>
...
async function main() {
  ...
  console.log("✅ PDF saved: /tmp/parchemin-test.pdf (" + (buffer.length / 1024).toFixed(1) + " KB)");
}

...
import { downloadParchmentPdf } from "@/lib/pdf";
import { mysticAudio } from "@/lib/mysticAudio";
import { GoldButton } from "./GoldButton";
import { Seal } from "./Seal";
import roule from "@/assets/roule.png";
...
export function RevealStep({ data, pdfRef, onBack }: Props) {
    ...
    >
      ...
      {showOpen && (
        <motion.div
          ...
          style={{ width: "min(92vw, 794px)", maxWidth: "100%", transformOrigin: "center" }}
          initial={
          ...
          transition={{
            ...
            scaleY: { duration: reduce ? 0 : 1.15, ease: [0.16, 1, 0.3, 1] },
          }}
        >
          <div
          ...
          >
            ...
            >
              ...
              <Block>
                ...
                <p className="mt-1 font-hand text-2xl" style={{ color: "var(--ink)" }}>
              ...
              {data.sections.map((s, si) => (
                <Block key={s.title} delay={sectionDelayBase + si * 0.1}>

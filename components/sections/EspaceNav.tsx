  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-nuit">
      ...
      <div className="shrink-0 border-b border-ombre">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-7 lg:px-16.75">
      ...
      <div className="min-h-0 flex-1 overflow-hidden">
        <div className="mx-auto flex h-full max-w-7xl overflow-hidden px-0 lg:px-16.75">

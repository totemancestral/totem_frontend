      ...
      <section className="pb-32 px-5 md:px-10" style={{ background: "var(--nuit-profonde)" }}>
        ...
        >
          ...
          <div>
            ...
            <p>
              Le site est hébergé sur une infrastructure cloud sécurisée. Détails communiqués sur
              simple demande.
            </p>
          </div>
          <div>
            ...
            <p>
              L'ensemble des contenus présents sur ce site — textes, visuels, identité, charte — est
              protégé par les lois de propriété intellectuelle et appartient à SENYCE PARTNERS.

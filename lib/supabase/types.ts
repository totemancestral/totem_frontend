// Types générés depuis le schéma Supabase partagé avec totem_backend.
// Ne pas éditer à la main : régénérer via `supabase gen types typescript`.
...
export type Database = {
  ...
  public: {
    Tables: {
      // Ajoutée à la main (CLI Supabase non disponible dans cet environnement) :
      // à faire disparaître au prochain vrai `supabase gen types typescript`.
      admin_audit_log: {
        Row: {
          id: string;
          admin_id: string;
